...
from libs.datasets import CELEB, DOG
        ...
        while not coord.should_stop() and epoch_i < n_epochs:
            ...
            if batch_i % 50 == 0:
                ...
                utils.montage(
                    ...
                    'data/imgs/manifold_%08d.png' % t_i)
                ...
                utils.montage(
                    recon.reshape([-1] + crop_shape),
                    'data/imgs/reconstruction_%08d.png' % t_i)
                t_i += 1
